...
headerTemplate.innerHTML = `
  <a href="index.html"><img src="assests/images/logo.png" alt="" height="100px" width="150px"></a>
...
footerTemplate.innerHTML = `
  ...
  <div class="socialMedia">
    ...
    <a href="https://www.instagram.com" target="_blank"> <img src="assests/images/instagram.png" alt="" width="22px" height="20px"> </a>
...
function performLogin(){
  ...
  if (usernameValue === "admin" && passwordValue === "admin"){
    document.querySelector('#header-login').innerText = "ut";
...
// Perform ut on clicking ut button on header
function performut(){
  if (document.querySelector('#header-login').innerText === "ut"){
...
document.querySelector('#header-login').addEventListener('click', performut);
